...
students.studentName = `Ayush Kamboj`;
...
console.log(`Yes we can define a key with let or var name because a key is a string and whatever we define a key it wll convert it into a string like let become "let" ;`);
