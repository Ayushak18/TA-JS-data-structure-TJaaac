...
for (let i = 0; i < got.houses[0].people.length; i++) {
  console.log(
    `People in ${got.houses[0].name} - ${got.houses[0].people[i].name}`
  );
}
...
for (let i = 0; i < got.houses[1].people.length; i++) {
  console.log(
    `People in ${got.houses[1].name}- ${got.houses[1].people[i].name}`
  );
}
...
for (let i = 0; i < got.houses[1].people.length; i++) {
  console.log(
    `Description ${got.houses[1].name}- ${got.houses[1].people[i].description}`
  );
}
...
for (let i = 0; i < got.houses[0].people.length; i++) {
  if (got.houses[0].people[i].name === `Robb Stark`) {
    console.log(
      `I am Robb Stark and my bio is ${got.houses[0].people[i].description}`
    );
  }
}
...
for (let i = 0; i < got.houses[1].people.length; i++) {
  if (got.houses[1].people[i].name === `Tywin Lannister`) {
    console.log(
      `I am Tywin Lannister and my bio is ${got.houses[1].people[i].description}`
    );
  }
}
...
for (let y = 0; y < got.houses.length; y++) {
  for (let i of got.houses[y].people) {
    console.log(i.name);
  }
}
...
for (let y = 0; y < got.houses.length; y++) {
  for (let person of got.houses[y].people) {
